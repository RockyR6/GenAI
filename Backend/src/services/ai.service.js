...
//         contents: "Hello, Explain what is Interview ?"
//     })
...
- Identify at least 5 skill gaps.
- Create a 7-day preparation plan.
- Never return empty arrays.
- Base all questions on the resume and job description.
  ...
  "technicalQuestions": [
    {
      ...
      "answer": "Discuss useState, useEffect, and custom hooks."
    }
  ],
  "behavioralQuestions": [
    {
...
Every element in technicalQuestions, behavioralQuestions, skillGaps and preparationPlan MUST be an object.
`;
  ...
  // Validate the parsed JSON against the interview report schema.
